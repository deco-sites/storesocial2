...
export default function ProductSpecialContent({
	page,
	firstContentNotMilk,
	secondContentNotMilk,
	firstContentNotMilkHighProtein,
	secondContentNotMilkHighProtein,
	firstContentNotMayo,
	secondContentNotMayo
	...
	return (
		<div class="w-full container py-8 flex flex-col gap-6 lg:py-10 cs-all-tablet:pb-0">
			<div class="max-w-[1120px] flex gap-10 justify-center flex-col mx-auto my-0 full-phone:gap-0">
				{
					brandName === "NotMilk" && (
						<div class="max-w-[1120px] flex gap-10 justify-center flex-col mx-auto my-0 full-phone:gap-5">
