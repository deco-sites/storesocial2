//import Searchbar from "deco-sites/staging/components/search/Searchbar.tsx";
import Searchbar404 from "./Searchbar404.tsx";
...
export default function Page404({ title, text, photo }: Props) {
  return (
    <div class="w-full flex flex-col justify-center items-center pt-[68px] pb-[68px] mx-auto max-w-9/10 lg:max-w-full full-phone:px-5 full-phone:pt-[150px]">
      ...
      <div className="flex flex-col items-center mb-16">
        ...
        <div className="pageSearchbar w-full sm:max-w-9/10">
          <Searchbar404 buttonClose={false} />
        </div>
      </div>
      <a
        href="/"
